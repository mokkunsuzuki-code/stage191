# -*- coding: utf-8 -*-
# Stage69 common helper: write pure-ASCII C header for AES-GCM using OpenSSL EVP.

HEADER_NAME = "hybrid_common.h"
...
def main():
    with open(HEADER_NAME, "w", encoding="ascii", newline="\n") as f:
        f.write(HEADER_TEXT)
    print(f"[Stage69] wrote header: {HEADER_NAME}")
